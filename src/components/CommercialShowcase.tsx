    ...
    <section className="px-5 sm:px-8 lg:px-12 max-w-[1320px] mx-auto w-full pt-6 sm:pt-8 pb-16 sm:pb-24 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        ...
        <div className="lg:col-span-8 p-2 sm:p-2.5 rounded-[2.5rem] bg-black/[0.03] border border-black/[0.06] shadow-card flex flex-col">
          <div className="rounded-[calc(2.5rem-0.625rem)] relative overflow-hidden bg-primary text-white min-h-[490px] sm:min-h-[530px] flex flex-col justify-between p-6 sm:p-10 lg:p-12 flex-1">
            ...
            <div className="relative z-10 flex flex-wrap items-center justify-between gap-3">
              <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/15">
                <span className="text-[12px] text-[#D4AF37]">★</span>
                <span className="text-[10.5px] font-semibold uppercase tracking-[0.18em] text-[#D4AF37]">
                  {s.main.badge}
                </span>
              </div>
              ...
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/10 text-[11px] font-medium text-white/90">
                <span className="material-symbols-outlined text-[14px] text-[#D4AF37]">handshake</span>
                <span>Caracas • Marcas Aliadas</span>
              </div>
            </div>
            ...
            <div className="relative z-10 my-6 sm:my-8 space-y-5">
              ...
              <div className="grid grid-cols-3 gap-2.5 sm:gap-4 pt-2 max-w-xl">
                <div className="p-3 rounded-2xl bg-black/40 backdrop-blur-md border border-white/10 text-left">
                  <div className="font-serif text-lg sm:text-xl font-bold text-[#D4AF37]">
                    {s.main.stat1Value}
                  </div>
                  <div className="text-[10.5px] sm:text-[11.5px] text-white/75 leading-tight mt-0.5">
                    {s.main.stat1Label}
                  </div>
                </div>
            ...
            <div className="relative z-10 pt-5 border-t border-white/15 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
        ...
        <div className="lg:col-span-4 flex flex-col sm:grid sm:grid-cols-2 lg:flex lg:flex-col gap-6">
          ...
          <div className="p-2 sm:p-2.5 rounded-[2.25rem] bg-black/[0.03] border border-black/[0.06] shadow-card flex-1 flex flex-col">
            <div className="rounded-[calc(2.25rem-0.5rem)] relative overflow-hidden bg-surface-container-lowest p-6 sm:p-7 flex flex-col justify-between flex-1 min-h-[250px] border border-black/[0.04] group hover:border-primary/30 transition-all duration-300">
              
              {/* Subtle background photo watermark */}
              <div className="absolute right-0 bottom-0 w-44 h-44 opacity-[0.07] pointer-events-none rounded-full overflow-hidden translate-x-8 translate-y-8">
                <Image
              ...
              <div className="space-y-3 relative z-10">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-bold uppercase tracking-[0.18em] text-primary bg-primary/10 px-3 py-1 rounded-full">
                    {s.card1.badge}
                  </span>
                ...
                <h3 className="font-serif text-xl sm:text-2xl font-semibold text-on-surface leading-tight tracking-tight">
                  {s.card1.title}
                </h3>

                <p className="text-[12.5px] text-on-surface-variant/80 leading-relaxed font-normal">
                  {s.card1.subtitle}
                </p>
              </div>

              {/* Card Bottom */}
              <div className="pt-4 mt-3 border-t border-black/[0.05] relative z-10 flex flex-col gap-2">
                <span className="text-[11px] font-semibold text-primary/90 flex items-center gap-1.5">
          ...
          <div className="p-2 sm:p-2.5 rounded-[2.25rem] bg-black/[0.03] border border-black/[0.06] shadow-card flex-1 flex flex-col">
            <div className="rounded-[calc(2.25rem-0.5rem)] relative overflow-hidden bg-[#24131A] text-white p-6 sm:p-7 flex flex-col justify-between flex-1 min-h-[250px] group hover:shadow-elevated transition-all duration-300">
              ...
              <div className="space-y-3 relative z-10">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#D4AF37] bg-white/10 border border-[#D4AF37]/30 px-3 py-1 rounded-full backdrop-blur-sm">
                    {s.card2.badge}
                  </span>
                ...
                <h3 className="font-serif text-xl sm:text-2xl font-semibold text-white leading-tight tracking-tight">
                  {s.card2.title}
                </h3>
              ...
              {/* Card Bottom */}
              <div className="pt-4 mt-3 border-t border-white/10 relative z-10 flex flex-col gap-2">
                <span className="text-[11px] font-medium text-[#D4AF37] flex items-center gap-1.5">
