  ...
  return (
    <div className="bg-background text-on-background min-h-screen flex flex-col selection:bg-primary/10 selection:text-primary">
      ...
      <main className="flex-grow">
        {/* ─── HERO SECTION (Macro-Whitespace & High Contrast Typography) ─── */}
        <section className="relative pt-16 sm:pt-24 pb-28 sm:pb-36 px-5 sm:px-8 lg:px-12 max-w-[1320px] mx-auto w-full text-center flex flex-col items-center">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-black/[0.03] border border-black/[0.06] mb-8 animate-fade-in">
            ...
            <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-primary">
              1.400 msnm • Valle de Uco, Mendoza
            </span>
          </div>
          ...
          <p className="text-[15px] sm:text-lg text-on-surface-variant/80 max-w-2xl mx-auto leading-relaxed mb-10 text-balance animate-fade-in-up">
            Catas guiadas de colección, degustación directa de barricas y maridajes de autor al pie de los Andes.
          </p>

          {/* Primary & Secondary Actions (Button-in-Button pattern) */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mt-16 sm:mt-20 w-full max-w-3xl pt-10 border-t border-black/[0.05]">
            <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
              <span className="font-serif text-2xl sm:text-3xl font-semibold text-primary">1.400 m</span>
              <span className="text-[12px] text-on-surface-variant/70 mt-0.5">Altitud de Viñedos</span>
            </div>
            <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
              <span className="font-serif text-2xl sm:text-3xl font-semibold text-primary">20 cupos</span>
              <span className="text-[12px] text-on-surface-variant/70 mt-0.5">Grupos Exclusivos</span>
            </div>
            <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
              <span className="font-serif text-2xl sm:text-3xl font-semibold text-primary">Pase QR</span>
              <span className="text-[12px] text-on-surface-variant/70 mt-0.5">Check-in Inmediato</span>
            </div>
          </div>
        </section>
        ...
        {/* ─── EDITORIAL TERROIR SPLIT (High-End Photography & Story) ─── */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-semibold text-on-surface tracking-tight leading-[1.12]">
                Vinos Moldeados por el Frío de los Andes
              </h2>

              <p className="text-[14px] sm:text-base text-on-surface-variant/80 leading-relaxed font-normal">
                En el Valle de Uco, a 1.400 metros de altura, la radiación solar y la marcada amplitud térmica de 20°C concentran aromas de violetas y frutas negras con una acidez vibrante y natural.
              </p>

              <p className="text-[14px] sm:text-base text-on-surface-variant/80 leading-relaxed font-normal">
                Nuestras partidas son vinificadas en piletas de hormigón y barricas de roble francés de grano fino, buscando reflejar con pureza la mineralidad de los suelos de piedra caliza.
              </p>
              ...
              <div className="pt-2">
                ...
                >
                  <span>Conocer la historia de la bodega</span>
        ...
        {/* ─── LIVE SENSORY TASTING CALLOUT (Luxury Deep Wine Card) ─── */}
            ...
            <div className="rounded-[calc(2.5rem-0.625rem)] bg-[#5C0531] text-white p-8 sm:p-14 lg:p-16 relative overflow-hidden">
              <div className="max-w-2xl space-y-6 relative z-10">
                <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-[#D4AF37] bg-white/10 px-3.5 py-1 rounded-full backdrop-blur-sm">
                  Experiencia Digital en Bodega
                </span>

                <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-semibold leading-tight">
                  Ficha de Cata Sensorial Interactiva
                </h2>

                <p className="text-[14px] sm:text-base text-white/80 leading-relaxed font-normal">
                  Durante cada degustación, los asistentes acceden desde su smartphone a la rueda interactiva de aromas, audio-guía del enólogo y calificación en vivo para obtener su certificado de degustador oficial.
                </p>
                ...
                <div className="pt-4 flex flex-col sm:flex-row gap-4">
                  ...
                  >
                    <span>Probar Demo Sensorial</span>
        ...
        <section id="contacto" className="py-20 sm:py-28 px-5 sm:px-8 lg:px-12 max-w-[1320px] mx-auto w-full text-center">
          <div className="max-w-xl mx-auto space-y-4">
            ...
            <p className="text-[13px] sm:text-sm text-on-surface-variant/80">
              Diseñamos catas corporativas, aniversarios y agasajos privados con sommelier exclusivo y traslado ejecutivo.
            </p>
            <div className="pt-3">
              <Link
                href="/privadas"
